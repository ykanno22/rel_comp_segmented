...
% load('bi-modulus_1d_data_set.mat');
% load('tri-modulus_1d_data_set.mat');
load('tri_no_compress_data_set.mat');
% load('sigmoid_1d_data_set.mat');
...
%
filename.std = 'miqp_segmented_no_compress';
% <---
% Some parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
opt_c_no = opt_c;
opt_nb_no = opt_nb;
intersec_pt_no = intersec_pt;
data_eps_no = data_eps;
data_sig_no = data_sig;
save('segmented_no_compress.mat',...
    'opt_a_no', 'opt_b_no', 'opt_c_no',...
    'opt_nb_no', 'intersec_pt_no',...
    'data_eps_no', 'data_sig_no');
